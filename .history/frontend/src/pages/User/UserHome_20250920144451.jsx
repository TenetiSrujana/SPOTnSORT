...
const UserHome = () => {
  ...
  return (
    <div className="relative text-white overflow-y-auto scroll-smooth min-h-screen">
      ...
      {/* Canvas Bubbles floating behind content */}
      <BubblesBackground />
      ...
      {/* Hero Section */}
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-32 pb-24 relative z-10">

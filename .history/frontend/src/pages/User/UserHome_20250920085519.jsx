  ...
  return (
    <div className="relative text-white">
      ...
      <section className="pt-32 pb-24 px-6 text-center">
        ...
        <p className="text-lg max-w-3xl mx-auto mb-6 drop-shadow-md">
      ...
      {/* How It Works */}
      <section className="px-6 py-24 bg-black bg-opacity-50 backdrop-blur-sm w-full">
        <h3 className="text-4xl font-bold mb-12 text-yellow-400 text-center">How SpotnSort Works</h3>
        <div className="flex flex-col md:flex-row md:space-x-10 space-y-8 md:space-y-0 max-w-6xl mx-auto">
          <div className="flex-1">
            <h4 className="text-2xl font-semibold mb-3 text-yellow-400">Step 1: Spot the Issue</h4>
            <p>Identify a civic problem like potholes, broken lights, garbage, etc., and capture a photo.</p>
          </div>
          <div className="flex-1">
            <h4 className="text-2xl font-semibold mb-3 text-yellow-400">Step 2: Report Instantly</h4>
            <p>Submit details including location, category, and description using SpotnSort.</p>
          </div>
          <div className="flex-1">
            <h4 className="text-2xl font-semibold mb-3 text-yellow-400">Step 3: Authority Verification</h4>
            <p>Authorities receive notifications, verify the issue, and take action quickly.</p>
          </div>
          <div className="flex-1">
            <h4 className="text-2xl font-semibold mb-3 text-yellow-400">Step 4: Track & Resolve</h4>
      ...
      <section className="px-6 py-24 w-full">
        <h3 className="text-4xl font-bold mb-12 text-yellow-400 text-center">Impact & Recent Reports</h3>
        <div className="flex flex-col md:flex-row md:space-x-10 space-y-8 md:space-y-0 max-w-6xl mx-auto">
          <div className="flex-1 p-6 bg-black bg-opacity-60 rounded-xl shadow-lg">
            ...
            <img src="/assets/before.png" alt="Before" className="mt-4 rounded shadow-md" />
          </div>
          <div className="flex-1 p-6 bg-black bg-opacity-60 rounded-xl shadow-lg">
            ...
            <img src="/assets/after.png" alt="After" className="mt-4 rounded shadow-md" />
          </div>
        </div>
      </section>
      ...
      {/* Analytics Graph */}
      <section className="px-6 py-24 bg-black bg-opacity-50 backdrop-blur-sm w-full">
        <h3 className="text-4xl font-bold mb-10 text-yellow-400 text-center">Monthly Reports vs Resolved</h3>

...
import { FaArrowLeft, FaInfoCircle, FaGift } from "react-icons/fa";
...
export default function UserRewards() {
  ...
  useEffect(() => {
    ...
    const handleStorage = () => calculateRewards();
    ...
    <div className="relative min-h-screen text-white overflow-y-auto scroll-smooth">
      ...
      <div className="relative z-10 p-6 pt-28 space-y-6">
        ...
        <div className="rounded-2xl shadow-md bg-black bg-opacity-50 p-6">
          ...
          <p className="text-gray-300 mt-2">{progress.completed}/{progress.target} reports submitted</p>
        </div>

        {/* Reward Offers */}
        <div className="rounded-2xl shadow-md bg-black bg-opacity-50 p-6 space-y-4">
          <h2 className="text-xl font-semibold mb-4 text-yellow-400 flex items-center gap-2"><FaGift /> Redeem Rewards</h2>

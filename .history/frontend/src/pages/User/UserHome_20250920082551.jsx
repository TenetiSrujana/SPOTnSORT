...
const UserHome = () => {
  ...
  return (
    <div className="relative text-white min-h-screen overflow-x-hidden">
      ...
      {/* How It Works */}
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 py-12 bg-black bg-opacity-50 backdrop-blur-sm">
        <h3 className="text-4xl font-bold mb-12 text-yellow-400">How SpotnSort Works</h3>
        <div className="flex flex-col md:flex-row md:space-x-10 space-y-8 md:space-y-0 max-w-6xl text-left">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row md:space-x-10 space-y-8 md:space-y-0 max-w-6xl">
      ...
      {/* Analytics Graph */}
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 py-12 bg-black bg-opacity-50 backdrop-blur-sm">
        <h3 className="text-4xl font-bold mb-10 text-yellow-400">Monthly Reports vs Resolved</h3>

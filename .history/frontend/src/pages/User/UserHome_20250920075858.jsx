    ...
    <div className="page-wrapper relative text-white">
      ...
      <header className="fixed top-0 left-0 w-full bg-black bg-opacity-70 shadow-md z-50">
        <nav className="flex justify-between items-center px-8 py-4">
          <h1 className="text-2xl font-bold text-yellow-500">SpotnSort</h1>
          <ul className="flex space-x-6 font-semibold">
            <li className="cursor-pointer hover:text-yellow-500" onClick={() => navigate("/user/home")}>Home</li>
            <li className="cursor-pointer hover:text-yellow-500" onClick={() => navigate("/user/report")}>Report</li>
            <li className="cursor-pointer hover:text-yellow-500" onClick={() => navigate("/user/map")}>Map</li>
            <li className="cursor-pointer hover:text-yellow-500" onClick={() => navigate("/user/analysis")}>Analyzer</li>
            <li className="cursor-pointer hover:text-yellow-500" onClick={() => navigate("/user/rewards")}>Rewards</li>
            <li className="cursor-pointer hover:text-red-500" onClick={() => navigate("/")}>Logout</li>
          </ul>
        </nav>
      </header>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6">
        <h2 className="text-5xl font-bold mb-4">
          Spot the Problem, <span className="text-yellow-500">Sort the City</span>
        </h2>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6">
        ...
        <p className="max-w-4xl mb-6">
          ...
          SpotnSort empowers citizens to <span className="text-yellow-500">spot issues</span>,  

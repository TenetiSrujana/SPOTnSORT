...
const Analytics = () => {
  ...
  // Load reports initially and listen for updates
  const loadReports = () => {
  ...
  useEffect(() => {
    ...
    // Listen for storage events to auto-update charts and recent reports
    const handleStorageChange = () => loadReports();
    window.addEventListener("storage", handleStorageChange);

    // Optional: Poll every second for updates (useful if same tab update)
